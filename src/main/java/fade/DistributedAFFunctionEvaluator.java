...
//		});
		evaluators.forEach(action -> System.out.println(action));
...
//					return item;
//				})
				// 调用evaluatePartialAFValue
				.flatMapToPair(item -> {
//					System.out.println("item._1");
//					System.out.println(item._1);
//					System.out.println("item._2");
//					item._2.forEach(System.out::println);
					...
					while (iter1.hasNext()) {
						...
						for (int i = 0; i < evaluators.size(); i++) {
							...
							e.setCount1(e.getConf().getLong("len_s" + v1._1.id) - k+1);  // 获取kmer的总数
